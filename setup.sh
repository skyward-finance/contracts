...
near deploy $CONTRACT_ID skyward/res/skyward.wasm new '{
...
# TIME=$(date +%s)
# START_TIME=$(expr $TIME + 3600)
START_TIME=1623801600 # 2021-06-16
near call $CONTRACT_ID --accountId=$CONTRACT_ID sale_create '{"sale": {
                "title": "[TESTNET] 25% TEST_SKYWARD sale",
                "url": "https://skyward.finance/test_sale",
                "out_tokens": [{
